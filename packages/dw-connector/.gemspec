...
require_relative "lib/dw-connector/version"

Gem::Specification.new do |spec|
  spec.name = "dw-connector"
  ...
  spec.metadata["source_code_uri"] = "#{spec.homepage}/tree/main/packages/dw-connector"
  spec.metadata["changelog_uri"] = "#{spec.homepage}/blob/main/packages/dw-connector/CHANGELOG.md"
