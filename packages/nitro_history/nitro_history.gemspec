...
Gem::Specification.new do |s|
  ...
  s.add_dependency "directory", "0.0.1"
  s.add_dependency "nitro_attr_encrypted", "0.0.1"
  s.add_dependency "nitro_auth", "0.0.1"
  s.add_dependency "nitro_config", "0.1.1"
  s.add_dependency "nitro_graphql", "0.0.1"
  s.add_dependency "nitro_mysql", "0.0.1"
  ...
  s.add_development_dependency "rspec-rails", "4.1.1"
