...
ActiveRecord::Schema[8.0].define(version: 20_250_421_183_613) do
  ...
  create_table "two_percent_group_memberships", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index %w[group_id user_id], name: "index_two_percent_group_memberships_on_group_id_and_user_id", unique: true
