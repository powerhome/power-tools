...
RSpec.describe DWConnector::Adapters::TrinoRepository do
  ...
  describe "#query" do
    ...
    context "when the query fails" do
      ...
      it "raises an error with the error message" do
        expect { repository.query }.to raise_error(DWConnector::Error, /Query failed/)
      end
    end
  end
  ...
  describe "#execute" do
    ...
    context "when the query fails" do
      ...
      it "raises an error with the error message" do
        expect { repository.execute(sql_query) }.to raise_error(DWConnector::Error, /Query failed/)
      end
    end
  end
end
