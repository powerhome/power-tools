...
describe OStruct::Sanitizer do
  ...
  describe "#truncate" do
    ...
    it "does not sanitize if value is nil" do
      user = user_class.new first_name: nil, last_name: nil
  ...
  describe "#alphanumeric" do
    ...
    it "does not sanitize if value is nil" do
      user = user_class.new city: nil, country: nil
  ...
  describe "#strip" do
    ...
    it "does not sanitize if value is nil" do
      user = user_class.new email: nil, phone: nil
  ...
  describe "#digits" do
    ...
    it "does not sanitize if value is nil" do
      user = user_class.new ssn: nil, cell_phone: nil
  ...
  describe "#sanitize" do
    ...
    context "hash syntax" do
      ...
      it "applies sanitization rules using string as key in the constructor" do
        user = user_class.new "my ssn" => "111-11-1111"
        expect(user[:"my ssn"]).to eq "111111111"
      end
    end
  end
